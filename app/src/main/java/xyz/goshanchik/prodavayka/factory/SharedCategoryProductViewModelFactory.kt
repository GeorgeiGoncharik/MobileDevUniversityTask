...
class SharedCategoryProductViewModelFactory(val categoryId: Int, val application: Application): ViewModelProvider.Factory {
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(SharedCategoryProductViewModel::class.java))
            return SharedCategoryProductViewModel(categoryId, application) as T
